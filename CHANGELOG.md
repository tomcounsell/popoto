...
- **Two behavior changes ship default-on with [#491](https://github.com/tomcounsell/popoto/issues/491).** Both are beta-substrate changes to the agent-memory layer; core ORM behavior is untouched.

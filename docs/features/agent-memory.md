...
| Reconciliation | Claim equivalence classes over the journal: typed contradiction rules, a total precedence table, explicit disjunctions, and a replayable merge log | [page](reconciliation.md) |
| Belief-Sheet View | Read-path claim resolver over the journal: retractions dropped, supersessions collapsed, reader gate, replayable | [page](belief-sheet-view.md) |

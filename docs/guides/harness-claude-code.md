...
In your Redis or Valkey, in the `DefaultMemory:*` keyspace, partitioned by
an `agent_id` that defaults to the basename of your working directory. Two
projects on one Redis do not see each other's memories.

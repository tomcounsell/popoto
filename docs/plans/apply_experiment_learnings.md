...
- [x] A `--parametric` sweep produces nDCG@5 variance > 0.05 for at least 5 constants. *(Closed 2026-04-20 by issue #362 follow-up: `sweep_20260420_051055.json` shows 6 sensitive constants — `initial_weight` 0.144, `WILSON_CI_THRESHOLD` 0.130, `decay_per_hop` 0.112, `_wf_min_threshold` 0.068, `decay_rate` 0.067, `COMPETITIVE_SUPPRESSION_SIGNAL` 0.053. The new `PredictionLedgerFamilyScenario` / `ContextAssemblerFamilyScenario` / `PolicyCacheFamilyScenario` directly produced the `WILSON_CI_THRESHOLD` and `COMPETITIVE_SUPPRESSION_SIGNAL` sensitivity; the other four were preserved through 7-family averaging.)*

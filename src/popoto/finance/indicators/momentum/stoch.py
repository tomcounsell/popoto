...
class StochSubscriber(IndicatorSubscriber):
    ...
    def handle(self, channel, data, *args, **kwargs):
        ...
        new_stoch_storage = StochStorage(
        ...
        for horizon in HORIZONS:
            ...
            high_value_np_array = new_stoch_storage.get_denoted_price_array(
                "high_price", periods
            )
            low_value_np_array = new_stoch_storage.get_denoted_price_array(
                "low_price", periods
            )
            close_value_np_array = new_stoch_storage.get_denoted_price_array(
                "close_price", periods
            )
            ...
            slowk, slowd = talib.STOCH(
                ...
                fastk_period=horizon * 5,
                slowk_period=horizon * 3,
                slowk_matype=0,
                slowd_period=horizon * 3,
                slowd_matype=0,
            )[-1]

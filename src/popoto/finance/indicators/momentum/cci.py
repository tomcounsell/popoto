...
class CciSubscriber(IndicatorSubscriber):
    ...
    def handle(self, channel, data, *args, **kwargs):
        ...
        for horizon in HORIZONS:
            ...
            high_value_np_array = new_cci_storage.get_denoted_price_array(
                "high_price", periods
            )
            low_value_np_array = new_cci_storage.get_denoted_price_array(
                "low_price", periods
            )
            close_value_np_array = new_cci_storage.get_denoted_price_array(
                "close_price", periods
            )

...
class StochfSubscriber(IndicatorSubscriber):
    ...
    def handle(self, channel, data, *args, **kwargs):
        ...
        new_stochf_storage = StochfStorage(
        ...
        for horizon in HORIZONS:
            ...
            high_value_np_array = new_stochf_storage.get_denoted_price_array(
                "high_price", periods
            )
            low_value_np_array = new_stochf_storage.get_denoted_price_array(
                "low_price", periods
            )
            close_value_np_array = new_stochf_storage.get_denoted_price_array(
                "close_price", periods
            )

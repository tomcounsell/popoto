...
class AroonOscSubscriber(IndicatorSubscriber):
    ...
    def handle(self, channel, data, *args, **kwargs):
        ...
        new_aroonosc_storage = AroonOscStorage(
        ...
        for horizon in HORIZONS:
            ...
            high_value_np_array = new_aroonosc_storage.get_denoted_price_array(
                "high_price", periods
            )
            low_value_np_array = new_aroonosc_storage.get_denoted_price_array(
                "low_price", periods
            )
